...
public class PersistenceApi implements IApi {
	...
	@Override
	public void registrarTarea(String name, int id_project, String usuarioPropietario, String priority, String user, boolean estado,
			String descripcion, LocalDate inicio, LocalDate fin)
			throws DataEmptyException, NotNullException, InvalidDateException {
		Tarea tarea = new Tarea(name, id_project, usuarioPropietario, priority, user, estado, descripcion, inicio, fin);
